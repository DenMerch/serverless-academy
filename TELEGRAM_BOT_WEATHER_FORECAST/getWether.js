...
async function getWether(time) {
    try {
        const response = await axios.get(`https://api.openweathermap.org/data/2.5/weather?q=London,uk&exclude=hourly${time}&units=metric&APPID=c2cc8080c2365e0bc78252b80ce17f5c`);
